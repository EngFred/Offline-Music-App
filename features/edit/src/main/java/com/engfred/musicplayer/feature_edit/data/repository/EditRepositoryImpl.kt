...
class EditRepositoryImpl @Inject constructor() : EditRepository {
    ...
    /**
     * Scoped-storage-safe metadata editor using JAudioTagger.
     * 1. Copies content to Temp1 (Cache).
     * 2. Copies Temp1 to Temp2 (Ensures valid size/headers).
     * 3. JAudioTagger modifies Temp2.
     * 4. Streams Temp2 back to original Uri.
     */
    override suspend fun editAudioMetadata(
        ...
        var mimeType = context.contentResolver.query(uri, projection, null, null, null)?.use { cursor ->
        ...
        try {
            ...
            jaudiotaggerAudioFile.file = temp2  // Explicitly set to ensure correct path for backup/rename
            val tag: Tag = jaudiotaggerAudioFile.tagOrCreateAndSetDefault
            ...
            temp1.delete()
            temp2.delete()
            File(temp1.absolutePath + ".bak").delete()
            File(temp2.absolutePath + ".bak").delete()
        }
    }

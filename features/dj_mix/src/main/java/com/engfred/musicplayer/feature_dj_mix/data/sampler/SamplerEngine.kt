 ...
 *
 * ── Auto-trigger map (2 strategies) ─────────────────────────────
 *
 * Strategy          │ On START       │ Mid 1               │ Mid 2               │ On DROP
 * ──────────────────┼────────────────┼─────────────────────┼─────────────────────┼──────────
 * HARMONIC          │ REWIND_SWEEP   │ WHITE_NOISE_UP (40%)│ STUTTER_HIT   (70%) │ AIR_HORN
 * WIDE_TRANSITION   │ SIREN          │ RISER_SWEEP    (30%)│ IMPACT_HIT    (55%) │ AIR_HORN
 * ─────────────────────────────────────────────────────────────────────────────────────────
...
class SamplerEngine @Inject constructor(
    ...
    companion object {
        ...
        private const val MID_FRACTION_HARMONIC_1       = 0.40f  // WHITE_NOISE_UP
        private const val MID_FRACTION_HARMONIC_2       = 0.70f  // STUTTER_HIT

        // WIDE_TRANSITION mid triggers
        private const val MID_FRACTION_WIDE_TRANSITION_1 = 0.30f  // RISER_SWEEP
        private const val MID_FRACTION_WIDE_TRANSITION_2 = 0.55f  // IMPACT_HIT — nadir
    ...
    private fun midTriggersFor(strategy: MixStrategy): List<Pair<Float, SampleId>> = when (strategy) {
        ...
        MixStrategy.HARMONIC -> listOf(
            MID_FRACTION_HARMONIC_1 to SampleId.WHITE_NOISE_UP,  // 40%
            MID_FRACTION_HARMONIC_2 to SampleId.STUTTER_HIT      // 70%
        )

        MixStrategy.WIDE_TRANSITION -> listOf(
            MID_FRACTION_WIDE_TRANSITION_1 to SampleId.RISER_SWEEP,  // 30%
            MID_FRACTION_WIDE_TRANSITION_2 to SampleId.IMPACT_HIT    // 55%
        )
    }
    ...
    private fun onDropCompleted(strategy: MixStrategy) {
        // AIR_HORN on every drop — afrobeats/dancehall energy on both strategies.
        // CROWD_HEY stays available as a manual pad but is too polite for auto.
        val sample = SampleId.AIR_HORN

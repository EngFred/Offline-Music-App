...
abstract class DjMixDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        val MIGRATION_5_6 = object : Migration(5, 6) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("ALTER TABLE bpm_cache ADD COLUMN customCueInMs INTEGER DEFAULT NULL")
                db.execSQL("ALTER TABLE bpm_cache ADD COLUMN customMixOutMs INTEGER DEFAULT NULL")
            }
        }
    }
}